...
var OrdenDeCompra = (function () {
    function OrdenDeCompra(ticket, formato) {
        if (formato === void 0) { formato = "json"; }
        this.request = new Listar_1.Listar(ticket, "ordenesdecompra", formato);
    }
    OrdenDeCompra.prototype.buscarCodigo = function (codigo) {
    ...
    OrdenDeCompra.prototype.buscarHoy = function () {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    OrdenDeCompra.prototype.buscarFecha = function (fecha) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    OrdenDeCompra.prototype.buscarEstado = function (estado) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    OrdenDeCompra.prototype.buscarOrganizmoFecha = function (codigoOrganismo, fecha) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    OrdenDeCompra.prototype.buscarProveedorFecha = function (codigoProveedor, fecha) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                switch (_a.label) {
